            ...
            <form class="modal-body" id="inspForm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group"><label>รูปถ่าย PEA No./แผ่นป้าย/Nameplate Photo</label>
                        <div class="photo-upload" id="photoNameplate"><div class="photo-dropzone" data-field="imageNameplate"><i data-lucide="image"></i><p>Click or drag</p><input type="file" accept="image/*" capture class="photo-input" /></div>
